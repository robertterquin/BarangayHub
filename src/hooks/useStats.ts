...
export function useStats(): Stats {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('stats')
      .on('postgres_changes', { event: '*', schema: 'public', table: 'document_requests' }, () => { void fetchStats(); })
      .on('postgres_changes', { event: '*', schema: 'public', table: 'complaints' }, () => { void fetchStats(); })
      .subscribe();
